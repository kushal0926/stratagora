...
export default function QuickAnalyzeSection({
    ...
    const handleAnalyze = async () => {
        ...
        setTimeout(() => {
            alert(
                "Analysis feature coming soon! This will work without login.",
            );
            setIsLoading(false);
        }, 1000);
    };
    ...
    return (
        <Card className="max-w-2xl mx-auto bg-[FFFFF0] border text-black space-y-5">
            <CardContent>
                <Tabs value={activeTab} onValueChange={setActiveTab}>
                    ...
                    <TabsContent value="chesscom" className="space-y-4">
                        <div className="space-y-2">
                            <label className="text-md font-bold text-gray-700">
                                <span className="text-zinc-700">Chess.com</span>{" "}
                                username
                            </label>
                            <Input
                    ...
                    <TabsContent value="lichess" className="space-y-4">
                        <div className="space-y-2">
                            <label className="text-md font-bold text-gray-700">
                                <span className="text-zinc-700">Lichess</span>{" "}
                                username
                            </label>
                            <Input
